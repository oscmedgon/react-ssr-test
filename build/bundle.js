...
var Home = function Home() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      null,
      'Hola mundo soy la home m\xE1s molona'
    ),
    _react2.default.createElement(
      'button',
      { onClick: function onClick() {
          return console.log('Why did you press that button');
        } },
      'Don\'t Press Me!!!'
    )
  );
...
var fetchUsers = exports.fetchUsers = function fetchUsers() {
    return function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dyspatch) {
            var url, res;
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            url = 'https://react-ssr-api.herokuapp.com/users';
                            res = _axios2.default.get(url);
